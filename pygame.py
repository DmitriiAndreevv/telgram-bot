...
cols = (WIDTH // TITLE + 1)// 2
rows = (HEIGHT // TITLE + 1)// 2
...
class Cell:
    ...
    def draw(self):
        ...
        if self.visited:
            pygame.draw.rect(screen, pygame.Color('red'), (x, y, TITLE, TITLE))

        if not self.walls['top']:
            pygame.draw.rect(screen, pygame.Color('red'),(x , y - TITLE, TITLE, TITLE))
        if not self.walls['right']:
            pygame.draw.rect(screen, pygame.Color('red'),(x + TITLE, y, TITLE, TITLE))
